...
# Jalankan proses
main_folder_path = 'D:/SEMESTER6/PengenalaPola/analisis_kain_glcm_rgb/data'
output_folder_path = 'D:/SEMESTER6/PengenalaPola/analisis_kain_glcm_rgb/outputs/glcm_results'
